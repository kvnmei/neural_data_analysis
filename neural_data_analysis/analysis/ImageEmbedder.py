...
# NOT USED
def create_image_embeddings(images: torch.Tensor, embedder_list: list[str], embedder_specs: dict, device: torch.device) -> dict[str, torch.Tensor]:
    """
    ...
    for embedder_name in embedder_list:
        ...
        image_embedder = embedder_from_spec(embedder_specs[embedder_name], device)
